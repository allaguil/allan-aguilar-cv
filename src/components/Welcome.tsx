        ...
        <>
            <Container>
                ...
                <Box>
                    ...
                    <Typography variant='body1' mt={1} sx={{ padding:'0 20px', fontSize:'18px', fontFamily:'Pangolin' }}><span style={{ fontSize:'24px', }}>I'm Allan</span>, I am a Front End Developer, I have over 10 years of work experience, I'm currently working as a Front End Developer for Critical Mass, with previous experience working for prestigious Corporates like Intel Corporation, Western Union, Cisco Systems and Citi Bank.</Typography>
